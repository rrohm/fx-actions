...
/**
 * Default annotation manager for FXActionManager annotations.
 *
 * @author Robert Rohm &lt;r.rohm@aeonium-systems.de&gt;
 */
public class DefaultFXManagerAnnotationHandler implements AnnotationHandler<FXAManager> {

  private FXActionManager manager;

  public DefaultFXManagerAnnotationHandler() {
  }

  DefaultFXManagerAnnotationHandler(FXActionManager manager) {
  ...
  public void handle(Object controller, Field field, FXAManager fxAction) {
    try {
      ...
      Logger.getLogger(DefaultFXManagerAnnotationHandler.class.getName()).log(Level.SEVERE, null, ex);
    }
  }
