...
public @interface FXBehaviour {
   ...
   *             responsible for deciding whether to use a singleton or not.
   *             This should then only server for overriding that default.
   *             ... but check whether this makes sense at all!
   */
